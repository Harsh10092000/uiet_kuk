...
const TrainingPlacementContent = () => {
  return (
    <div>
      ...
      <section className="placement-block" id="placements">
        <div className="container-fluid">
          <ul className="nav nav-pills">
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-toggle="pill" href="#y2024">
                2024
              </a>
            </li>
            <li className="nav-item">
          ...
          <div className="tab-content mt-5">
                        ...
                        <div className="col-md-6">
                          <div className="table-responsive mb-5 rounded">
                            <table className="table text-left">
                              ...
                              <tbody>
                                <tr>
                                  <td className="s2 bg-primary text-white">
                                    Infosys{" "}
                                  </td>
                                  <td className="s3 bg-primary "></td>
                                </tr>
                                <tr>
                                  <td className="s4">AASTHA SAINI</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ABHISHEK RANA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">GAURAV JAIN</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">VINAY RATHI</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SHILKY GUPTA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">AASHI JAIN</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SWATI NARANG</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SHUBHAM CHAUDHARY</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SHIVANI PRUTHI</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">NIKHIL KUMAR</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">HIMANSHU DALAL</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">DEEPAK KADYAN</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ANUBHAV</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ARJUN JOSHI</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">AAYUSH BEHAL</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">KUNAL ARORA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">VAIBHAV GOYAL</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">PIYUSH VARSHNEY</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">HARSHIT KUMAR</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">CHAMANDEEP SHARMA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">CHIRAG</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ANKIT PALARWAL</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SAHIL KALRA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ANUSHEEL DEWANI</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">SANYAM DEWAN</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">A VINOD KUMAR</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">ANUJ SINHA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">APARNA ROHILA</td>
                                  <td className="s1">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  ...
                                  <td className="s3  bg-primary text-white"></td>
                                </tr>
                                <tr>
                                  <td className="s4">ANSHUL KUMAR</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">LOVISH AGHI</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">AAYUSH AGGARWAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">AADESH MITTAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SHWETA SAINI</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">STUTI VARSHNEY</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">NIDHI GURANIA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">ROHAN YADAV</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  <td className="s4  bg-primary text-white">
                                    sahitya RATAN
                                  </td>
                                  <td className="s1  bg-primary text-white"></td>
                                </tr>
                                <tr>
                                  <td className="s4">RISHABH AGGARWAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">AARYAN VARDHAN</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">NIKHIL SHARMA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">HIMANSHU GANGWAR </td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SALONI VATS</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SOURABH SHUKLA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  <td className="s4">RAMAN GARG</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">ANUJ AGGARWAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SHUBHAM KANSAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SHUBHAM </td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SHUBHAM JAIN</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">AADESH MITTAL</td>
                                ...
                                <tr>
                                  <td className="s4">RASIKA GARG</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">AAYUSH AGGARWAL</td>
                                ...
                                <tr>
                                  <td className="s4">ROHIT SAINI</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">GOURAV JAIN</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                          ...
                          <div className="table-responsive mb-5 rounded">
                            <table className="table text-left">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td className="s4">RANVIR SINGH</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SABRIT CHACKO</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">SAHIL KALRA</td>
                                ...
                                <tr>
                                  <td className="s4">YUVRAJ SINGH RATHORE</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  <td className="s2">IDS INFOTECH</td>
                                  <td className="s3"></td>
                                </tr>
                                <tr>
                                  <td className="s4">ADITYA ARORA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">KUNTAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">NISHA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">GURLEEN</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">JIGYASA VERMA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  <td className="s4">Nishant VERMA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Chetna</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Harsha</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">SAHITYA RATAN</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">Jyoti VERMA</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Antriksh Saini</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Bhawna Singh</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Saloni Kumari</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Nishant Kumari</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">Abhiram Kumar</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Manish Kumar</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">DEEPAK Rana</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">GULSHAN Sharma</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">HITESH SINGH</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">LOVEPREET AGGARWAL</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">MANISH Kaushik</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">NARESH</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">VIVEK</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s7">SIMRAN MAKKAR</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">RAHUL TYAGI</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">Sumit Kumar</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Manas Jha</td>
                                  <td className="s1"></td>
                                </tr>
                                <tr>
                                  <td className="s1"></td>
                                ...
                                <tr>
                                  <td className="s4">Manoj Kumar</td>
                                  <td className="s1">2</td>
                                </tr>
                                <tr>
                                  <td className="s8"></td>
                                  <td className="s8"></td>
                                ...
                                <tr>
                                  <td className="s2">TCS</td>
                                  <td className="s3"></td>
                                </tr>
                                <tr>
                                  <td className="s9">Isita Bhoye</td>
                                  <td className="s9">3.36</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
            ...
            <div className="tab-pane fade" id="y2019">
              <div className="main-tittle">
                <h2>Placements for the year 2019</h2>
              </div>
                            ...
                            <table className="table text-left">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="s3 bg-primary text-whit"></td>
                                </tr>
                                <tr>
                                  <td className="s4">Shilpa Nagpal</td>
                                  <td className="s4">8</td>
                                </tr>
                                <tr>
                                  <td className="s4">GOURAV PANDEY</td>
                                  <td className="s4">8</td>
                                </tr>
                                <tr>
                                  <td className="s4">CHINTAN JAIN</td>
                                  <td className="s4">5</td>
                                </tr>
                                <tr>
                                  <td className="s4">ARUN BANSAL</td>
                                  <td className="s4">5</td>
                                </tr>
                                <tr>
                                  <td className="s4">ROHAN MALIK</td>
                                  <td className="s4">5</td>
                                </tr>
                                <tr>
                                  <td className="s4">SHIKHAR GOEL</td>
                                  <td className="s4">5</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mayank</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Varsha</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Abhishek</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ramandeep</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Anmol</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Sagar</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Anshuman</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Navkiran</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Rupali</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Devanshi</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ankita</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Naveen</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Rohan</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Udita</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Tanya</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Cheshta</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Diksha</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mehul</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Nishant</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Deeksha</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mukul</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Akshay</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ayush</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Gaurav</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Diksha</td>
                                ...
                                <tr>
                                  <td className="s4">Aditi</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Aniket</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Vikrant</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ravneet</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Tarun</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ayush</td>
                                ...
                                <tr>
                                  <td className="s4">Twinkle</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Sumit</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Rajesh</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Manisha</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mayank</td>
                                ...
                                <tr>
                                  <td className="s4">Anjali</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Anupama</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Sahil</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Raja</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mohd</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Jaya</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mandeep</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Alankar</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Kapil</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Anita</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Srishti</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Nitya</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Kusum</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Bharti</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Shivam</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Jashanpreet</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Sakshi</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Vasav</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Nishu</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Sahil</td>
                                ...
                                <tr>
                                  <td className="s4">Ishan</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Vaibhav</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Vishal</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4">Akash</td>
                                  <td className="s4">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">Tarun Bhardwaj</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Reman Saini</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Aniket Taneja</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Yuvraj Bhanot</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Chintan Jain</td>
                                ...
                                <tr>
                                  <td className="s4">Devanshi Mahajan</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Tanya Gupta</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Mahima Sharma</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Nitish Aggroia</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Prashant </td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Garima Dixit</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Harroshan </td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Harshit Garg</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Vijay Kumar</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Suhani Bhatnagar</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Harmanjyot </td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Navkiran </td>
                                ...
                                <tr>
                                  <td className="s4">Aditi Garg</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ankit Gupta</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Cheshta </td>
                                ...
                                <tr>
                                  <td className="s4">Jeevanshu Sethi</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Neeraj Kaushik</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Geetika </td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4">Srishti </td>
                                ...
                                <tr>
                                  <td className="s4">Kunal Bhardwaj</td>
                                  <td className="s4">3.35</td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                          ...
                          <div className="table-responsive mb-5 rounded">
                            <table className="table text-left">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td className="s4">HARROSHAN</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">YUGAL SALUJA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">HARMANJYOT</td>
                                ...
                                <tr>
                                  <td className="s4">AYUSH GOEL</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">NAMAN</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4 ">UDITA MALHOTRA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">YUVRAJ BHANOT</td>
                                ...
                                <tr>
                                  <td className="s4">SAGAR KUMAR MISHRA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">CHESHTA</td>
                                ...
                                <tr>
                                  <td className="s4">GARIMA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">AMAR</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">RAVNEET KAUR</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">RUPALI TANEJA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">VAIBHAV GARG</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">GOURAV</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">TUSHAR MOHAN</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">SIDDHARTH SHARMA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">JAYA BAJAJ</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">TUSHAR GOYAL</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">RAJA</td>
                                ...
                                <tr>
                                  <td className="s4">VAIBHAV MEHTA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">ARUN BANSAL</td>
                                ...
                                <tr>
                                  <td className="s4">ANOOP</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">MUKUL SHARMA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">PRAGATI YADAV</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">JASHANPREET KAUR</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">ANKUR GOYAL</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">VINEET GUPTA</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">Harshit Garg</td>
                                ...
                                <tr>
                                  <td className="s5">Ankur Goyal</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s5">Pankaj Sharma</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s5">Kamal singh</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s5">Shubham Sharma</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s5"></td>
                                ...
                                <tr>
                                  <td className="s4">Md. Huzefa</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4">Ajay Singh</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s4"></td>
                                ...
                                <tr>
                                  <td className="s4">Aalok Kumar</td>
                                ...
                                <tr>
                                  <td className="s6">Gaurav Singh</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s6">Simran phutela</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s6">Abhilasha Parmar</td>
                                  <td className="s4">3.5</td>
                                </tr>
                                <tr>
                                  <td className="s6"></td>
                                ...
                                <tr>
                                  <td className="s6">Nishu Ram</td>
                                  <td className="s4">10.4</td>
                                </tr>
                                <tr>
                                  <td className="s6">Sunny Panchal</td>
                                  <td className="s4">10.4</td>
                                </tr>
                                <tr>
                                  <td className="s7"></td>
                                ...
                                <tr>
                                  <td className="s9">ashish chaudhary</td>
            ...
            <div className="tab-pane fade" id="y2020">
              <div className="main-tittle">
                <h2>Placements for the year 2020</h2>
              </div>
              <div className="graph-content shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <h3>Firm v/s Package (LPA)</h3>
                <div className="row">
                            ...
                            <table className="table text-left">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Devanshi Gupta</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">
                                    Jha Ansuman Sanjay Kumar
                                  </td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Jasjot Singh</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Charu Goyal</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Uddeshy Dhingra</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Rajat Bhola</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Rahul Dahiya</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Swati Verma</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Pawan Bir</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Ramandeep Singh</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Kaptan Singh</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Vivek Kumar</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Anjali Juyal</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Abhishek Bagga</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Ridhima Kandhari</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Krishan Gopal Yadav</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Yogesh Na</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Vickram Saini</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Priya Chhabra</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Nidhi Soni</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Rashmi Rohila</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Dikshant Anthal</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Aditya Bhat</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Deepak Malik</td>
                                  <td className="s2">8</td>
                                </tr>
                                <tr>
                                  <td className="s2">Kumari Monika</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Sachin Lather</td>
                                  <td className="s2">5</td>
                                </tr>
                                <tr>
                                  <td className="s2">Saurabh Saurabh</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Nisha Rani</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Naresh Saharan</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Sumit Tyagi</td>
                                  <td className="s2">5</td>
                                </tr>
                                <tr>
                                  <td className="s2">Satyam Kumar</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Shilpa Sharma</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Arjun Singh Mor</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Tapendra Joshi</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="s2">Sumit Kataria</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Rhythm Bhatia</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Mohit Malik</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Gurkirat Singh</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Bhavy Sharma</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Devashish Garg</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Rohit Dabas</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Shubham Gahlyan</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Priyanka Goyal</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Chhavi Kant Gaur</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2">Gourav Kumar</td>
                                  <td className="s2">3.6</td>
                                </tr>
                                <tr>
                                  <td className="s2"></td>
            ...
            <div className="tab-pane fade" id="y2022">
              <div className="main-tittle">
                <h2>Placements for the year 2022</h2>
              </div>
              <div className="graph-content shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <h3>Firm v/s Package (LPA)</h3>
                <div className="row">
            ...
            <div className="tab-pane fade" id="y2023">
              <div className="main-tittle">
                <h2>Placements for the year 2023</h2>
              </div>
              <div className="graph-content shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <h3>Firm v/s Package (LPA)</h3>
                <div className="row">
            ...
            <div className="tab-pane fade" id="y2024">
              <div className="main-tittle">
                <h2>Placements for the year 2024</h2>
              </div>
              <div className="graph-content shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <h3>Firm v/s Package (LPA)</h3>
                <div className="row">
            ...
            <div className="tab-pane fade" id="y2025">
              <div className="main-tittle">
                <h2>Placements for the year 2025</h2>
              </div>
              <div className="graph-content shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <h3>Firm v/s Package (LPA)</h3>
                <div className="row">
...
export default TrainingPlacementContent;
