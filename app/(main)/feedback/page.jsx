...
<div className="col-md-6">
 ...
 <div className="col-md-12">
           <div className="form-floating mb-3">
           <textarea rows="3" cols="5" className="form-control" id="feedback" placeholder="Feedback/ Grievance/ Suggestion :"></textarea>
            <label for="floatingPassword">Feedback/ Grievance/ Suggestion :</label>
          </div>
          </div>
       </div>
