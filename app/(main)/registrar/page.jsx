            ...
            <div class="row">
              <div class="col-sm-10 col-md-12 col-lg-3">
                <div className="aboutpict mb-40">
                  <img src="/virender-pal.png" class="img-fluid" />
                </div>
              </div>
              ...
              <div class="col-sm-10 col-md-12 col-lg-8">
                <div className="contact-panel mb-40">
                  <h2>
                    Lt. (Dr.) Virender pal
                    <span className="red d-block">Registrar</span>
                  </h2>
                  ...
                  <ul className="peronal-detail">
                    <li>
                      ...
                      <a href="tel:911744238026">+91-1744-238026</a>
                    </li>

                    <li>
                      <strong>E-mail :</strong>
                      <a href="mailto:registrar@kuk.ac.in">
                        registrar@kuk.ac.in
                      </a>
                    </li>
                    <li>
