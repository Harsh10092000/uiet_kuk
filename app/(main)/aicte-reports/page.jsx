...
LEFT JOIN notification_ordering no ON n.id = no.notification_id 
  AND no.context_type = 'page' AND no.context_value = 'Aicte Reports'
WHERE n.page_aicte_reports = 1 AND n.is_active = 1
...
const page = async () => {
    ...
    return (
        <NotificationsList results={results} page_name={"AICTE Reports"} />
    );
};
