...
const Page = () => {
    const departmentData = facultyData["applied-sciences-department"] || [];

    return (
        <div>
            <section className="pages-title mb-4">
                <div className="container">
                    <h2>Department of Applied Sciences</h2>
                    ...
                    <ul className="breadcrumb text-center mx-auto">
                        ...
                        <li className="breadcrumb-item">
                            <Link href="/applied-sciences-department">
