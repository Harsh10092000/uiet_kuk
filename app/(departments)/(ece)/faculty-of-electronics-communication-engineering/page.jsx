...
const Page = () => {
    const departmentData = facultyData["electronics-and-communication-engg-department"] || [];

    return (
        <div>
            <section className="pages-title mb-4">
                <div className="container">
                    <h2>Department of Electronics & Communication Engg.</h2>
                    ...
                    <ul className="breadcrumb text-center mx-auto">
                        ...
                        <li className="breadcrumb-item">
                            <Link href="/electronics-and-communication-engg-department">
                                Department of Electronics & Communication Engg.
                            </Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">
                            Faculty of Electronics & Communication Engg.
                        </li>
                    </ul>
                </div>
            </section>
