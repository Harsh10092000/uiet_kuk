...
const Page = () => {
    const departmentData = facultyData["biotechnology-engg-department"] || [];

    return (
        <div>
            <section className="pages-title mb-4">
                <div className="container">
                    <h2>Department of Biotechnology Engg.</h2>
                    ...
                    <ul className="breadcrumb text-center mx-auto">
                        ...
                        <li className="breadcrumb-item">
                            <Link href="/biotechnology-engg-department">
                                Department of Biotechnology Engg.
                            </Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">
                            Faculty of Biotechnology Engg.
                        </li>
                    </ul>
                </div>
            </section>
