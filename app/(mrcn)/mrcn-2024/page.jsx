      ...
      <section className="banner network-bg">
        <div className="container">
          <div className="banner-content">
            <h2>5th International Conference</h2>
            <h3>Mobile Radio Communications & 5G Networks – 2024 (5th in series )</h3>
      ...
      <div className="main-content">
        <div className="container">
          ...
          <p>
            ...
            independent referees from the panel of international reviewers.
          </p>
