    ...
    <div>
      ...
      <section className="main-content mt-5 mb-5 ">
        <div class="container">
            ...
            <div class="table-responsive shadow-lg  mb-5 bg-body-tertiary rounded">
    <table class="table table-bordered  text-center">
      ...
      <tbody>
        <tr>
          ...
          <td><img src="/pj-george.jpg" alt="pict" className="border border-light-subtle p-1" /></td>         
        </tr>

          <tr className="table-light">
          <td className="pt-5">Prof. O. P. Bajpai</td>
          <td className="pt-5">18-Aug-2006 to 30-June-2010</td>
          <td><img src="/op-bajpai.jpg" alt="pict" className="border border-light-subtle p-1" /></td>         
        </tr>
          ...
          <td><img src="/dinesh-agarwal.jpg" alt="pict" className="border border-light-subtle p-1" /></td>         
        </tr>
          ...
          <td><img src="/sunildhingra.jpg" alt="pict" className="border border-light-subtle p-1" /></td>         
        </tr>

         <tr>
          <td className="pt-5">Prof. C.C. Tripathi</td>
          <td className="pt-5">20-May-2016 to 05-May-2022</td>
          <td><img src="/tripathi.jpg" alt="pict" className="border border-light-subtle p-1" /></td>         
        </tr>
